...
export default function(name: string, required: boolean, type: PropType, originalProperty: Property) {
    const argumentProperty = new Property(name,  {
        required,
        type,
        description: '',
        defaultValue: { computed: false, value: '' },
    }, originalProperty.component, false);
