...
type props<'date> = {
  ...
  onChange?: (
    ...
    Common.pickerChangeHandlerContext<DateTimeValidationError.t>,
  ) => unit,
  ...
  onError?: (DateTimeValidationError.t, Common.dateValue<'date>) => unit,
  ...
  slots?: PickerSlots.dateTimePickerSlots,
  /** The props used for each component slot. @default {} */
  slotProps?: PickerSlots.dateTimePickerSlotProps<'date>,
