...
function make$3(alt, childrenClassName, className, component, imgProps, sizes, src, srcSet, classes, style, children) {
  var tmp = { };
  if (alt) {
    tmp.alt = alt[0];
  }
...
function convertTransitionDuration_shape(madeObj) {
  var returnObj = { };
...
function make$4(className, invisible, _open, transitionDuration, classes, style, children) {
  var tmp = {
    open: _open
  };
  if (className) {
  ...
  var tmp$1 = Js_option.map((function (v) {
          if (typeof v === "number" || v[0] !== -908856609) {
            ...
            return unwrapValue(/* `Element */[
                        -744106340,
                        convertTransitionDuration_shape(v[1])
                      ]);
          }
        }), transitionDuration);
  if (tmp$1) {
...
var Backdrop$1 = /* module */[
  /* convertTransitionDuration_shape */convertTransitionDuration_shape,
  /* Classes */Classes$2,
  /* make */make$4
];
...
function make$5(badgeContent, className, color, component, classes, style, children) {
  var tmp = {
...
function make$7(className, onChange, showLabels, value, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$10(className, disableActionSpacing, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$11(className, component, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$12(action, avatar, className, component, subheader, title, classes, style, children) {
  var tmp = { };
  if (action) {
    tmp.action = action[0];
  }
...
function make$13(className, component, image, src, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$15(checked, checkedIcon, color, disabled, disableRipple, icon, id, indeterminate, indeterminateIcon, inputProps, inputRef, onChange, _type, value, classes, style, children) {
  var tmp = { };
...
function make$16(avatar, className, component, deleteIcon, label, onClick, onDelete, onKeyDown, tabIndex, classes, style, children) {
  var tmp = { };
  if (avatar) {
    tmp.avatar = avatar[0];
  }
...
function make$17(className, color, max, min, size, thickness, value, variant, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function convertTimeout_shape(madeObj) {
  var returnObj = { };
  returnObj["enter"] = Js_option.map(unwrapValue, madeObj["enter"]);
  returnObj["exit"] = Js_option.map(unwrapValue, madeObj["exit"]);
  return returnObj;
...
function timeout_enumToJs(param) {
  return Js_mapperRt.binarySearch(1, param, jsMapperConstantArray$11);
}

function timeout_enumFromJs(param) {
...
function make$19(className, collapsedHeight, component, _in, onEnter, onEntered, onEntering, onExit, onExiting, theme, timeout, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
var Collapse$1 = /* module */[
  /* convertTimeout_shape */convertTimeout_shape,
  /* timeout_enumToJs */timeout_enumToJs,
  /* timeout_enumFromJs */timeout_enumFromJs,
  /* Classes */Classes$16,
  /* make */make$19
];
...
function make$21(className, disableActionSpacing, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$23(className, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$24(className, disableTypography, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$25(_BackdropProps, className, disableBackdropClick, disableEscapeKeyDown, fullScreen, fullWidth, maxWidth, onBackdropClick, onClose, onEnter, onEntered, onEntering, onEscapeKeyDown, onExit, onExited, onExiting, _open, _PaperProps, transition, transitionDuration, classes, style, children) {
  ...
  var tmp$3 = Js_option.map((function (v) {
          if (typeof v === "number" || v[0] !== -908856609) {
            ...
            return unwrapValue(/* `Element */[
                        -744106340,
                        convertTransitionDuration_shape$1(v[1])
                      ]);
          }
        }), transitionDuration);
  if (tmp$3) {
...
var Dialog$1 = /* module */[
  ...
  /* convertTransitionDuration_shape */convertTransitionDuration_shape$1,
  /* Classes */Classes$21,
  /* make */make$25
];
...
function make$26(absolute, className, component, inset, light, classes, style, children) {
  var tmp = { };
  if (absolute) {
...
function make$27(anchor, className, elevation, _ModalProps, onClose, _open, _PaperProps, _SlideProps, theme, transitionDuration, variant, classes, style, children) {
  ...
  var tmp$3 = Js_option.map((function (v) {
          if (typeof v === "number" || v[0] !== -908856609) {
            ...
            return unwrapValue(/* `Element */[
                        -744106340,
                        convertTransitionDuration_shape$2(v[1])
                      ]);
          }
        }), transitionDuration);
  if (tmp$3) {
...
function make$28(className, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$29(className, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function convertTimeout_shape$1(madeObj) {
  var returnObj = { };
  returnObj["enter"] = Js_option.map(unwrapValue, madeObj["enter"]);
  returnObj["exit"] = Js_option.map(unwrapValue, madeObj["exit"]);
  return returnObj;
...
function make$32(_in, onEnter, onExit, theme, timeout, children) {
  var tmp = { };
  if (_in) {
    tmp.in = _in[0];
  }
...
var Fade$1 = /* module */[
  /* convertTimeout_shape */convertTimeout_shape$1,
  /* make */make$32
];
...
function make$33(checked, className, control, disabled, inputRef, label, name, onChange, value, classes, style, children) {
  var tmp = { };
  var tmp$1 = Js_option.map(unwrapValue, checked);
  if (tmp$1) {
    tmp.checked = tmp$1[0];
...
function make$34(className, component, disabled, error, fullWidth, margin, onBlur, onFocus, required, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$35(className, row, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$36(className, component, disabled, error, margin, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$37(className, component, disabled, error, focused, required, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$38(actionIcon, actionPosition, className, subtitle, title, titlePosition, classes, style, children) {
  var tmp = { };
  if (actionIcon) {
...
function make$39(className, cols, component, rows, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$40(cellHeight, className, cols, component, spacing, classes, style, children) {
  var tmp = { };
  var tmp$1 = Js_option.map((function (v) {
...
var GridList$1 = /* module */[
  /* cellHeight_enumToJs */cellHeight_enumToJs,
  /* cellHeight_enumFromJs */cellHeight_enumFromJs,
  /* Classes */Classes$35,
  /* make */make$40
];
...
function convertTimeout_shape$2(madeObj) {
  var returnObj = { };
  returnObj["enter"] = Js_option.map(unwrapValue, madeObj["enter"]);
  returnObj["exit"] = Js_option.map(unwrapValue, madeObj["exit"]);
  return returnObj;
...
var Grow$1 = /* module */[
  /* convertTimeout_shape */convertTimeout_shape$2,
  /* timeout_enumToJs */timeout_enumToJs$1,
  /* timeout_enumFromJs */timeout_enumFromJs$1,
  /* make */make$42
];
...
var Hidden$1 = /* module */[
  ...
  /* only_enumToJs */only_enumToJs,
  /* only_enumFromJs */only_enumFromJs,
  /* only_arrayOfToJs */only_arrayOfToJs,
  /* only_arrayOfFromJs */only_arrayOfFromJs,
  /* make */make$43
];
...
function make$45(className, color, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$46(className, component, disableTypography, position, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$49(className, color, value, valueBuffer, variant, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$50(className, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$51(className, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$52(className, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$53(className, disableTypography, inset, primary, secondary, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$54(button, className, component, _ContainerComponent, _ContainerProps, dense, disabled, disableGutters, divider, value, onFocus, onClick, classes, style, children) {
  var tmp = { };
  if (button) {
    tmp.button = button[0];
  }
...
function make$55(className, color, component, disableSticky, inset, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$56(className, component, dense, disablePadding, subheader, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function convertTransitionDuration_shape$3(madeObj) {
  var returnObj = { };
  returnObj["enter"] = Js_option.map(unwrapValue, madeObj["enter"]);
  returnObj["exit"] = Js_option.map(unwrapValue, madeObj["exit"]);
  return returnObj;
  ...
  var tmp$1 = Js_option.map((function (v) {
          if (typeof v === "number") {
            ...
            if (variant !== -908856609) {
              ...
              return unwrapValue(/* `Element */[
                          -744106340,
                          convertTransitionDuration_shape$3(v[1])
                        ]);
            }
          }
        }), transitionDuration);
...
function make$61(_BackdropComponent, _BackdropProps, className, container, disableAutoFocus, disableBackdropClick, disableEnforceFocus, disableEscapeKeyDown, disableRestoreFocus, hideBackdrop, keepMounted, manager, onBackdropClick, onClose, onEscapeKeyDown, onRendered, _open, classes, style, children) {
  var tmp = {
    open: _open
  };
...
function make$63(className, component, elevation, square, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function horizontal_enumToJs$1(param) {
  return Js_mapperRt.binarySearch(3, param, jsMapperConstantArray$53);
}

function horizontal_enumFromJs$1(param) {
...
function vertical_enumToJs$1(param) {
  return Js_mapperRt.binarySearch(3, param, jsMapperConstantArray$54);
}

function vertical_enumFromJs$1(param) {
  return Js_mapperRt.revSearch(3, jsMapperConstantArray$54, param);
}

function convertAnchorOrigin$1(madeObj) {
  var returnObj = { };
  if (madeObj) {
    var madeObj$1 = madeObj[0];
    returnObj["horizontal"] = Js_option.map((function (v) {
...
function make$71(action, anchorOrigin, autoHideDuration, className, disableWindowBlurListener, key, message, onClose, onEnter, onEntered, onEntering, onExit, onExited, onExiting, onMouseEnter, onMouseLeave, _open, resumeHideDuration, _SnackbarContentProps, transition, transitionDuration, classes, style, children) {
  var tmp = { };
  if (action) {
    tmp.action = action[0];
  }
  ...
  var tmp$5 = Js_option.map((function (v) {
          if (typeof v === "number" || v[0] !== -908856609) {
            ...
            return unwrapValue(/* `Element */[
                        -744106340,
                        convertTransitionDuration_shape$5(v[1])
                      ]);
          }
        }), transitionDuration);
  if (tmp$5) {
...
function make$73(active, alternativeLabel, className, completed, last, optional, orientation, transition, transitionDuration, classes, style, children) {
  var tmp = { };
  if (active) {
    tmp.active = active[0];
  }
  ...
  var tmp$2 = Js_option.map((function (v) {
          if (typeof v === "number") {
            ...
            if (variant !== -908856609) {
              ...
              return unwrapValue(/* `Element */[
                          -744106340,
                          convertTransitionDuration_shape$6(v[1])
                        ]);
            }
          }
        }), transitionDuration);
...
var StepContent$1 = /* module */[
  ...
  /* convertTransitionDuration_shape */convertTransitionDuration_shape$6,
  /* transitionDuration_enumToJs */transitionDuration_enumToJs$2,
  /* transitionDuration_enumFromJs */transitionDuration_enumFromJs$2,
  /* Classes */Classes$61,
  /* make */make$73
];
...
function make$74(active, completed, error, icon, classes, style, children) {
  var tmp = {
    icon: icon
  };
  if (active) {
...
function make$75(active, alternativeLabel, className, completed, disabled, error, icon, last, optional, orientation, classes, style, children) {
  var tmp = { };
  if (active) {
    tmp.active = active[0];
  }
...
function make$76(active, alternativeLabel, className, completed, connector, disabled, index, last, orientation, classes, style, children) {
  var tmp = { };
  if (active) {
    tmp.active = active[0];
  }
...
function make$78(className, color, nativeColor, titleAccess, viewBox, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$79(anchor, disableBackdropTransition, disableDiscovery, disableSwipeToOpen, _ModalProps, onClose, onOpen, _open, _PaperProps, swipeAreaWidth, theme, transitionDuration, variant, children) {
  ...
  var tmp$3 = Js_option.map((function (v) {
          if (typeof v === "number" || v[0] !== -908856609) {
            ...
            return unwrapValue(/* `Element */[
                        -744106340,
                        convertTransitionDuration_shape$7(v[1])
                      ]);
          }
        }), transitionDuration);
  if (tmp$3) {
...
function make$81(checked, checkedIcon, className, color, defaultChecked, disabled, disableRipple, icon, id, inputProps, inputRef, onChange, _type, value, classes, style, children) {
  var tmp = { };
  var tmp$1 = Js_option.map(unwrapValue, checked);
  if (tmp$1) {
    tmp.checked = tmp$1[0];
...
function make$84(className, component, numeric, padding, scope, sortDirection, variant, colSpan, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$87(_Actions, backIconButtonProps, colSpan, component, count, labelDisplayedRows, labelRowsPerPage, nextIconButtonProps, onChangePage, onChangeRowsPerPage, page, rowsPerPage, rowsPerPageOptions, _SelectProps, classes, style, children) {
  ...
  if (tmp$4) {
    tmp.rowsPerPageOptions = tmp$4[0];
  }
  if (_SelectProps) {
...
function make$88(className, component, hover, selected, onDoubleClick, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
  ...
  if (onDoubleClick) {
    tmp.onDoubleClick = onDoubleClick[0];
  }
...
function make$90(className, component, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$91(action, centered, className, fullWidth, indicatorColor, onChange, scrollable, scrollButtons, _TabScrollButton, textColor, theme, value, classes, style, children) {
  var tmp = { };
  if (action) {
    tmp.action = action[0];
  }
...
function make$93(className, disableGutters, classes, style, children) {
  var tmp = { };
  if (className) {
    tmp.className = className[0];
  }
...
function make$94(className, disableFocusListener, disableHoverListener, disableTouchListener, enterDelay, enterTouchDelay, id, leaveDelay, leaveTouchDelay, onClose, onOpen, _open, placement, _PopperProps, theme, title, classes, style, children) {
  var tmp = {
    title: title
  };
  if (className) {
...
function make$95(center, className, classes, style, children) {
  var tmp = { };
  if (center) {
    tmp.center = center[0];
  }
...
function convertTimeout_shape$4(madeObj) {
  var returnObj = { };
  returnObj["enter"] = Js_option.map(unwrapValue, madeObj["enter"]);
  returnObj["exit"] = Js_option.map(unwrapValue, madeObj["exit"]);
  return returnObj;
...
function make$97(_in, onEnter, onExit, theme, timeout, children) {
  var tmp = { };
  if (_in) {
    tmp.in = _in[0];
  }
...
var Zoom$1 = /* module */[
  /* convertTimeout_shape */convertTimeout_shape$4,
  /* make */make$97
];
