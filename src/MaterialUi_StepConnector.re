...
| LineVertical(className) => Js.Dict.set(obj, to_string(classType), className)
                            };
                            obj
                        },
                    );
            ...
            [@bs.obj] external makeProps : (~alternativeLabel: bool=?,
~className: string=?,
~orientation: string=?,
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/StepConnector/StepConnector"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
...
~classes: option(Classes.t)=?,~style: option(ReactDOMRe.Style.t)=?,
                children
                    ...
                    ~reactClass,
                    ~props=makeProps(~alternativeLabel=?alternativeLabel,
~className=?className,
