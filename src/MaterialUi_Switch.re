...
| Disabled(className)
| Bar(className) => Js.Dict.set(obj, to_string(classType), className)
                            };
                            obj
                        },
                    );
            ...
            [@bs.obj] external makeProps : (~checked: 'union_rdsy=?,
...
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/Switch/Switch"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
