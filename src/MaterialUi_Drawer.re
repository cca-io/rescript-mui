...
| [@bs.as "temporary"] `Temporary
                ...
                module Classes = {
                    type classesType = | Docked(string)
| Paper(string)
...
~_SlideProps: Js.t({..})=?,
~theme: Js.t({..})=?,
~transitionDuration: 'union_r6cd=?,
~variant: string=?,
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/Drawer/Drawer"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
