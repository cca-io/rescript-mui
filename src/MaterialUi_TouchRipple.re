...
| ChildPulsate(className) => Js.Dict.set(obj, to_string(classType), className)
                            };
                            obj
                        },
                    );
            ...
            [@bs.obj] external makeProps : (~center: bool=?,
~className: string=?,
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/ButtonBase/TouchRipple"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
                ~center: option(bool)=?,
