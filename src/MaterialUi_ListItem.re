...
| SecondaryAction(className) => Js.Dict.set(obj, to_string(classType), className)
            ...
            [@bs.obj] external makeProps : (~button: bool=?,
~className: string=?,
~component: 'union_r57h=?,
~_ContainerComponent: 'union_rlcm=?,
...
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/ListItem/ListItem"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
                ~button: option(bool)=?,
