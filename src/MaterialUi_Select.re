...
external makeProps :
  (
    ...
    ~onOpen: 'any_rlam=?,
    ~_open: bool=?,
    ~renderValue: 'any_rs6a=?,
    ~_SelectDisplayProps: Js.t({..})=?,
    ~value: 'union_r3yx=?,
    ~autoComplete: string=?,
    ~autoFocus: bool=?,
    ~className: string=?,
    ~defaultValue: 'union_rzh7=?,
    ~disabled: bool=?,
...
let make =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_r1cs => ReasonReact.reactElement)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_r6n4)=?,
