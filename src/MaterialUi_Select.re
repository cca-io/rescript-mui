...
let make =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_rj3g => ReasonReact.reactElement)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_r2y1)=?,
      ~inputRef:
         option(
