...
let make =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_rsj9 => ReasonReact.reactElement)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_rxtq)=?,
      ~inputRef:
         option(
