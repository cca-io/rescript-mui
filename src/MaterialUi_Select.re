...
let make =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_r7bi => ReasonReact.reactElement)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_rn5q)=?,
      ~inputRef:
         option(
