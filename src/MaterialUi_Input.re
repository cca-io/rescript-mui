...
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/Input/Input"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
...
~id: option(string)=?,
~inputComponent: option('any_rfvy)=?,
