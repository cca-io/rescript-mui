...
~expanded: bool=?,
~onChange: 'any_rnwd=?,
~component: 'union_ryvk=?,
~elevation: 'number_k=?,
~square: bool=?,
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/ExpansionPanel/ExpansionPanel"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
