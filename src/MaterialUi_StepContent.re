...
~transitionDuration: 'union_rvvn=?,
~_TransitionProps: Js.t({..})=?,
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/StepContent/StepContent"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
                ~active: option(bool)=?,
...
~_TransitionComponent=?_TransitionComponent,
~transitionDuration=?
