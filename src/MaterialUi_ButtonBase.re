                    ...
                    listOfClasses |. Belt.List.reduce(
                        ...
                        (obj, classType) => {
                            switch classType {
                                | Root(className)
| Disabled(className)
| FocusVisible(className) => Js.Dict.set(obj, to_string(classType), className)
                            };
                            obj
                        },
                    );
            ...
            [@bs.obj] external makeProps : (~action: 'any_rrdi=?,
~buttonRef: 'union_rn05=?,
~centerRipple: bool=?,
~className: string=?,
~component: 'union_r5le=?,
~disabled: bool=?,
~disableRipple: bool=?,
...
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/ButtonBase/ButtonBase"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
