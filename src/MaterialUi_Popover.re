...
external makeProps:
  (
    ~action: 'any_rgo2=?,
    ~anchorEl: 'union_r2lg=?,
    ~anchorOrigin: 'any_r02k=?,
    ~anchorPosition: 'any_rxcg=?,
    ~anchorReference: string=?,
    ~container: 'union_rgyp=?,
    ~elevation: 'number_1=?,
    ...
    ~_PaperProps: Js.t({..})=?,
    ~role: string=?,
    ~transformOrigin: 'any_rwqx=?,
    ~_TransitionComponent: 'union_rsiu=?,
    ~transitionDuration: 'union_rtup=?,
    ~_TransitionProps: Js.t({..})=?,
    ~_BackdropComponent: 'union_rpg3=?,
    ~_BackdropProps: Js.t({..})=?,
    ~className: string=?,
