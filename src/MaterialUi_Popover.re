                                ...
                                switch (obj) {
                                    | Some(obj) =>
                                        let unwrappedMap = Js.Dict.empty();
                                            ...
                                            switch (obj |. topGet |. Belt.Option.map((v) => MaterialUi_Helpers.unwrapValue(v))) {
                                                | Some(v) =>
                                                    unwrappedMap
                                                        |. Js.Dict.set(
                                                            "top",
                                            ...
                                            switch (obj |. leftGet |. Belt.Option.map((v) => MaterialUi_Helpers.unwrapValue(v))) {
                                                | Some(v) =>
                                                    unwrappedMap
                                                        |. Js.Dict.set(
                                                            "left",
...
| [@bs.as "none"] `None
                ...
                [@bs.deriving jsConverter]
                type transitionDuration_enum = [
                    | [@bs.as "auto"] `Auto
                ];

                module Classes = {
                    type classesType = | Paper(string);
            ...
            [@bs.obj] external makeProps : (~action: 'any_roef=?,
~anchorEl: 'union_r3ie=?,
~anchorOrigin: 'any_r0oq=?,
~anchorPosition: 'any_rxdw=?,
~anchorReference: string=?,
~container: 'union_rrnv=?,
~elevation: 'number_7=?,
~getContentAnchorEl: 'genericCallback=?,
~marginThreshold: 'number_e=?,
~onClose: 'any_ry8q=?,
...
~_PaperProps: Js.t({..})=?,
~role: string=?,
~transformOrigin: 'any_r0s2=?,
~_TransitionComponent: 'union_r4dy=?,
~transitionDuration: 'union_ry07=?,
~_TransitionProps: Js.t({..})=?,
~_BackdropComponent: 'union_ry6o=?,
~_BackdropProps: Js.t({..})=?,
~className: string=?,
...
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/Popover/Popover"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
                ~action: option((Js.t({..})) => unit)=?,
~anchorEl: option([ | `ObjectGeneric(Js.t({..})) | `Callback('genericCallback)  ])=?,
...
~transitionDuration: option([ | `Int(int) | `Float(float) | `Object(TransitionDuration_shape.t) | `Enum(transitionDuration_enum)  ])=?,
...
~anchorEl=?anchorEl |. Belt.Option.map((v => MaterialUi_Helpers.unwrapValue(v))),
~anchorOrigin=?AnchorOrigin.unwrap(anchorOrigin),
~anchorPosition=?AnchorPosition.unwrap(anchorPosition),
~anchorReference=?anchorReference |. Belt.Option.map((v => anchorReferenceToJs(v))),
...
~marginThreshold=?marginThreshold |. Belt.Option.map((v) => MaterialUi_Helpers.unwrapValue(v)),
~onClose=?onClose,
~onEnter=?onEnter,
~onEntered=?onEntered,
...
~transitionDuration=?
                    transitionDuration |. Belt.Option.map((v) => switch v {
                        | `Enum(v) => MaterialUi_Helpers.unwrapValue(`String(transitionDuration_enumToJs(v)))
