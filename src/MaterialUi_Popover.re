...
external makeProps:
  (
    ~action: 'any_rslt=?,
    ~anchorEl: 'union_rik4=?,
    ~anchorOrigin: 'any_rmgx=?,
    ~anchorPosition: 'any_rajs=?,
    ~anchorReference: string=?,
    ~container: 'union_rxy8=?,
    ~elevation: 'number_2=?,
    ~getContentAnchorEl: 'genericCallback=?,
    ~marginThreshold: 'number_p=?,
    ~_ModalClasses: Js.t({..})=?,
    ~onClose: 'any_rmay=?,
    ...
    ~_PaperProps: Js.t({..})=?,
    ~role: string=?,
    ~transformOrigin: 'any_rq2z=?,
    ~_TransitionComponent: 'union_r9jl=?,
    ~transitionDuration: 'union_rb8y=?,
    ~_TransitionProps: Js.t({..})=?,
    ~_BackdropComponent: 'union_rx5e=?,
    ~_BackdropProps: Js.t({..})=?,
    ~className: string=?,
