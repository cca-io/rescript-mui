...
external makeProps:
  (
    ~action: 'any_r33c=?,
    ~anchorEl: 'union_r5ev=?,
    ~anchorOrigin: 'any_ry2o=?,
    ~anchorPosition: 'any_r7n7=?,
    ~anchorReference: string=?,
    ~container: 'union_rog1=?,
    ~elevation: 'number_c=?,
    ...
    ~_PaperProps: Js.t({..})=?,
    ~role: string=?,
    ~transformOrigin: 'any_rt9l=?,
    ~_TransitionComponent: 'union_rtpg=?,
    ~transitionDuration: 'union_rsc0=?,
    ~_TransitionProps: Js.t({..})=?,
    ~_BackdropComponent: 'union_rxsb=?,
    ~_BackdropProps: Js.t({..})=?,
    ~className: string=?,
