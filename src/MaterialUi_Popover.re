...
external makeProps:
  (
    ~action: 'any_rd8f=?,
    ~anchorEl: 'union_ruhd=?,
    ~anchorOrigin: 'any_rpxw=?,
    ~anchorPosition: 'any_rwb7=?,
    ~anchorReference: string=?,
    ~container: 'union_r9t5=?,
    ~elevation: 'number_a=?,
    ...
    ~_PaperProps: Js.t({..})=?,
    ~role: string=?,
    ~transformOrigin: 'any_rh1n=?,
    ~_TransitionComponent: 'union_rx0y=?,
    ~transitionDuration: 'union_rwsh=?,
    ~_TransitionProps: Js.t({..})=?,
    ~_BackdropComponent: 'union_rbdt=?,
    ~_BackdropProps: Js.t({..})=?,
    ~className: string=?,
