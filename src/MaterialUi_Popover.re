...
external makeProps:
  (
    ~action: 'any_rutl=?,
    ~anchorEl: 'union_rrf0=?,
    ~anchorOrigin: 'any_rz3d=?,
    ~anchorPosition: 'any_rxks=?,
    ~anchorReference: string=?,
    ~container: 'union_rkys=?,
    ~elevation: 'number_7=?,
    ...
    ~_PaperProps: Js.t({..})=?,
    ~role: string=?,
    ~transformOrigin: 'any_r4mp=?,
    ~_TransitionComponent: 'union_ronh=?,
    ~transitionDuration: 'union_rpjj=?,
    ~_TransitionProps: Js.t({..})=?,
    ~_BackdropComponent: 'union_r5yw=?,
    ~_BackdropProps: Js.t({..})=?,
    ~className: string=?,
