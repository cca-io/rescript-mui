...
external makeProps:
  (
    ~action: 'any_ranl=?,
    ~anchorEl: 'union_rsht=?,
    ~anchorOrigin: 'any_rjds=?,
    ~anchorPosition: 'any_r1xb=?,
    ~anchorReference: string=?,
    ~container: 'union_r5wg=?,
    ~elevation: 'number_2=?,
    ...
    ~_PaperProps: Js.t({..})=?,
    ~role: string=?,
    ~transformOrigin: 'any_rk13=?,
    ~_TransitionComponent: 'union_rdfh=?,
    ~transitionDuration: 'union_rqfl=?,
    ~_TransitionProps: Js.t({..})=?,
    ~_BackdropComponent: 'union_raei=?,
    ~_BackdropProps: Js.t({..})=?,
    ~className: string=?,
