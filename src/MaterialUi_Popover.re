...
external makeProps:
  (
    ~action: 'any_r4h1=?,
    ~anchorEl: 'union_re34=?,
    ~anchorOrigin: 'any_r81g=?,
    ~anchorPosition: 'any_rh1z=?,
    ~anchorReference: string=?,
    ~container: 'union_rwo1=?,
    ~elevation: 'number_0=?,
    ...
    ~_PaperProps: Js.t({..})=?,
    ~role: string=?,
    ~transformOrigin: 'any_rsiw=?,
    ~_TransitionComponent: 'union_r9m8=?,
    ~transitionDuration: 'union_ryne=?,
    ~_TransitionProps: Js.t({..})=?,
    ~_BackdropComponent: 'union_rquy=?,
    ~_BackdropProps: Js.t({..})=?,
    ~className: string=?,
