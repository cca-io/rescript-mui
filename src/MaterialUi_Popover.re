...
external makeProps:
  (
    ~action: 'any_r7f9=?,
    ~anchorEl: 'union_rhcr=?,
    ~anchorOrigin: 'any_r3ah=?,
    ~anchorPosition: 'any_r6sy=?,
    ~anchorReference: string=?,
    ~container: 'union_rw2s=?,
    ~elevation: 'number_q=?,
    ...
    ~_PaperProps: Js.t({..})=?,
    ~role: string=?,
    ~transformOrigin: 'any_rcc9=?,
    ~_TransitionComponent: 'union_r1s5=?,
    ~transitionDuration: 'union_rnh3=?,
    ~_TransitionProps: Js.t({..})=?,
    ~_BackdropComponent: 'union_rfkd=?,
    ~_BackdropProps: Js.t({..})=?,
    ~className: string=?,
