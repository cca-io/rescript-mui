...
module BottomNavigationAction = {
  ...
  external makeProps :
    (
      ...
      ~onChange: ReactEventRe.Form.t=?,
      ~onClick: ReactEventRe.Mouse.t=?,
      ~selected: bool=?,
      ~showLabel: bool=?,
      ~value: 'any_o=?,
      ...
      ~onBlur: ReactEventRe.Focus.t=?,
      ~onFocus: ReactEventRe.Focus.t=?,
      ~onKeyboardFocus: ReactEventRe.Focus.t=?,
      ~onKeyDown: ReactEventRe.Keyboard.t=?,
      ~onKeyUp: ReactEventRe.Keyboard.t=?,
      ~onMouseDown: ReactEventRe.Mouse.t=?,
      ~onMouseLeave: ReactEventRe.Mouse.t=?,
      ~onMouseUp: ReactEventRe.Mouse.t=?,
      ~onTouchEnd: ReactEventRe.Touch.t=?,
      ~onTouchMove: ReactEventRe.Touch.t=?,
  ...
  let make =
      (
        ...
        ~onChange: option(ReactEventRe.Form.t)=?,
        ~onClick: option(ReactEventRe.Mouse.t)=?,
        ...
        ~onBlur: option(ReactEventRe.Focus.t)=?,
        ~onFocus: option(ReactEventRe.Focus.t)=?,
        ~onKeyboardFocus: option(ReactEventRe.Focus.t)=?,
        ~onKeyDown: option(ReactEventRe.Keyboard.t)=?,
        ~onKeyUp: option(ReactEventRe.Keyboard.t)=?,
        ~onMouseDown: option(ReactEventRe.Mouse.t)=?,
        ~onMouseLeave: option(ReactEventRe.Mouse.t)=?,
        ~onMouseUp: option(ReactEventRe.Mouse.t)=?,
        ~onTouchEnd: option(ReactEventRe.Touch.t)=?,
        ~onTouchMove: option(ReactEventRe.Touch.t)=?,
        ~onTouchStart: option(ReactEventRe.Touch.t)=?,
        ~role: option(string)=?,
...
module Chip = {
  ...
  let make =
      (
        ...
        ~label: option(ReasonReact.reactElement)=?,
        ~onClick: option(ReactEventRe.Mouse.t)=?,
        ~onDelete: option('emptyCallback_h)=?,
        ~onKeyDown: option(ReactEventRe.Keyboard.t)=?,
        ~tabIndex: option([ | `Int(int) | `Float(float) | `String(string)])=?,
        ~classes: option(Classes.t)=?,
        children,
...
module ClickAwayListener = {
  ...
  external makeProps :
    (
      ~mouseEvent: string=?,
      ~onClickAway: ReactEventRe.Mouse.t,
      ~touchEvent: string=?,
      unit
    ) =>
    _ =
...
module Collapse = {
  ...
  external makeProps :
    (
      ...
      ~onEntered: 'emptyCallback_h=?,
      ~onEntering: 'emptyCallback_m=?,
      ~onExit: 'emptyCallback_p=?,
      ~onExiting: 'emptyCallback_z=?,
      ~style: Js.t({..})=?,
      ~theme: Js.t({..}),
      ~timeout: 'union_4=?,
      ~classes: Js.Dict.t(string)=?,
  ...
  let make =
      (
        ...
        ~onEntered: option('emptyCallback_h)=?,
        ~onEntering: option('emptyCallback_m)=?,
        ~onExit: option('emptyCallback_p)=?,
        ~onExiting: option('emptyCallback_z)=?,
        ~style: option(Js.t({..}))=?,
        ~theme: Js.t({..}),
        ~timeout:
           option(
...
module Dialog = {
  ...
  external makeProps :
    (
      ...
      ~fullWidth: bool=?,
      ~maxWidth: string=?,
      ~onBackdropClick: ReactEventRe.Mouse.t=?,
      ~onClose: 'emptyCallback_6=?,
      ~onEnter: 'emptyCallback_r=?,
      ~onEntered: 'emptyCallback_y=?,
      ~onEntering: 'emptyCallback_c=?,
      ~onEscapeKeyDown: ReactEventRe.Keyboard.t=?,
      ~onExit: 'emptyCallback_t=?,
      ~onExited: 'emptyCallback_r=?,
      ~onExiting: 'emptyCallback_q=?,
      ~_open: bool,
      ~_PaperProps: Js.t({..})=?,
      ~transition: 'union_2=?,
      ~transitionDuration: 'union_c=?,
      ~_BackdropComponent: 'union_t=?,
      ~container: 'union_s=?,
  ...
  let make =
      (
        ...
        ~onBackdropClick: option(ReactEventRe.Mouse.t)=?,
        ~onClose: option('emptyCallback_6)=?,
        ~onEnter: option('emptyCallback_r)=?,
        ~onEntered: option('emptyCallback_y)=?,
        ~onEntering: option('emptyCallback_c)=?,
        ~onEscapeKeyDown: option(ReactEventRe.Keyboard.t)=?,
        ~onExit: option('emptyCallback_t)=?,
        ...
        ~manager: option(Js.t({..}))=?,
        ~onRendered: option('emptyCallback_e)=?,
        ~classes: option(Classes.t)=?,
        children,
      ) =>
    ReasonReact.wrapJsForReason(
...
module Grow = {
  ...
  let make =
      (
        ~_in: option(bool)=?,
        ~onEnter: option('emptyCallback_1)=?,
        ~onExit: option('emptyCallback_o)=?,
        ~style: option(Js.t({..}))=?,
        ~theme: Js.t({..}),
        ~timeout:
...
module Input = {
  ...
  external makeProps :
    (
      ...
      ~onBlur: ReactEventRe.Focus.t=?,
      ~onChange: ReactEventRe.Form.t=?,
      ~onEmpty: ReactEventRe.Synthetic.t=?,
      ~onFilled: ReactEventRe.Synthetic.t=?,
      ~onFocus: ReactEventRe.Focus.t=?,
      ~onKeyDown: ReactEventRe.Keyboard.t=?,
      ~onKeyUp: ReactEventRe.Keyboard.t=?,
      ~placeholder: string=?,
  ...
  let make =
      (
        ...
        ~onBlur: option(ReactEventRe.Focus.t)=?,
        ~onChange: option(ReactEventRe.Form.t)=?,
        ~onEmpty: option(ReactEventRe.Synthetic.t)=?,
        ~onFilled: option(ReactEventRe.Synthetic.t)=?,
        ~onFocus: option(ReactEventRe.Focus.t)=?,
        ~onKeyDown: option(ReactEventRe.Keyboard.t)=?,
        ~onKeyUp: option(ReactEventRe.Keyboard.t)=?,
...
module Menu = {
  ...
  external makeProps :
    (
      ...
      ~onExit: 'emptyCallback_8=?,
      ~onExited: 'emptyCallback_m=?,
      ~onExiting: 'emptyCallback_u=?,
      ~_open: bool,
      ~_PaperProps: Js.t({..})=?,
...
module Modal = {
  ...
  let make =
      (
        ...
        ~manager: option(Js.t({..}))=?,
        ~onBackdropClick: option(ReactEventRe.Mouse.t)=?,
        ~onClose: option('emptyCallback_q)=?,
        ~onEscapeKeyDown: option(ReactEventRe.Keyboard.t)=?,
        ~onRendered: option('emptyCallback_e)=?,
        ~_open: bool,
        ~classes: option(Classes.t)=?,
...
module Popover = {
  ...
  external makeProps :
    (
      ...
      ~getContentAnchorEl: ReasonReact.reactElement=?,
      ~marginThreshold: 'number_0=?,
      ~onClose: 'emptyCallback_n=?,
      ~onEnter: 'emptyCallback_b=?,
      ~onEntered: 'emptyCallback_9=?,
      ~onEntering: 'emptyCallback_l=?,
      ~onExit: 'emptyCallback_3=?,
      ~onExited: 'emptyCallback_h=?,
      ~onExiting: 'emptyCallback_o=?,
      ~_open: bool,
      ~_PaperProps: Js.t({..})=?,
      ~role: string=?,
      ~transformOrigin: 'shape_x=?,
  ...
  let make =
      (
        ...
        ~getContentAnchorEl: option(ReasonReact.reactElement)=?,
        ~marginThreshold: option([ | `Int(int) | `Float(float)])=?,
        ~onClose: option('emptyCallback_n)=?,
        ~onEnter: option('emptyCallback_b)=?,
        ~onEntered: option('emptyCallback_9)=?,
        ~onEntering: option('emptyCallback_l)=?,
        ~onExit: option('emptyCallback_3)=?,
        ~onExited: option('emptyCallback_h)=?,
        ~onExiting: option('emptyCallback_o)=?,
        ~_open: bool,
        ~_PaperProps: option(Js.t({..}))=?,
        ~role: option(string)=?,
        ~transformOrigin: option(transformOriginShape)=?,
...
module Portal = {
  ...
  [@bs.obj]
  external makeProps :
    (~container: 'union_i=?, ~onRendered: 'emptyCallback_3=?, unit) => _ =
    "";
  let make =
      (
        ~container:
        ...
        ~onRendered: option('emptyCallback_3)=?,
        children,
      ) =>
    ReasonReact.wrapJsForReason(
      ~reactClass,
...
module Slide = {
  ...
  external makeProps :
    (
      ~direction: string=?,
      ~_in: bool=?,
      ~onEnter: 'emptyCallback_h=?,
      ~onEntering: 'emptyCallback_r=?,
  ...
  let make =
      (
        ~direction: option(direction)=?,
        ~_in: option(bool)=?,
        ~onEnter: option('emptyCallback_h)=?,
        ~onEntering: option('emptyCallback_r)=?,
...
module Snackbar = {
  ...
  external makeProps :
    (
      ~action: ReasonReact.reactElement=?,
      ~anchorOrigin: 'shape_4=?,
      ~autoHideDuration: 'number_y=?,
      ~className: string=?,
      ~disableWindowBlurListener: bool=?,
      ~key: 'any_3=?,
      ~message: ReasonReact.reactElement=?,
      ~onClose: 'emptyCallback_k=?,
      ~onEnter: 'emptyCallback_e=?,
      ~onEntered: 'emptyCallback_j=?,
      ~onEntering: 'emptyCallback_0=?,
      ~onExit: 'emptyCallback_w=?,
      ~onExited: 'emptyCallback_d=?,
      ~onExiting: 'emptyCallback_e=?,
      ~onMouseEnter: ReactEventRe.Mouse.t=?,
      ~onMouseLeave: ReactEventRe.Mouse.t=?,
      ~_open: bool=?,
      ~resumeHideDuration: 'number_y=?,
  ...
  let make =
      (
        ...
        ~key: option('any_3)=?,
        ~message: option(ReasonReact.reactElement)=?,
        ~onClose: option('emptyCallback_k)=?,
        ~onEnter: option('emptyCallback_e)=?,
        ~onEntered: option('emptyCallback_j)=?,
        ~onEntering: option('emptyCallback_0)=?,
        ~onExit: option('emptyCallback_w)=?,
        ~onExited: option('emptyCallback_d)=?,
        ~onExiting: option('emptyCallback_e)=?,
        ~onMouseEnter: option(ReactEventRe.Mouse.t)=?,
        ~onMouseLeave: option(ReactEventRe.Mouse.t)=?,
        ~_open: option(bool)=?,
...
module SwipeableDrawer = {
  ...
  external makeProps :
    (
      ...
      ~_ModalProps: Js.t({..})=?,
      ~onClose: 'emptyCallback_s,
      ~onOpen: 'emptyCallback_6,
      ~_open: bool,
      ~_PaperProps: Js.t({..})=?,
      ~swipeAreaWidth: 'number_n=?,
      ~theme: Js.t({..}),
      ~transitionDuration: 'union_p=?,
      ~variant: string=?,
      ~className: string=?,
      ~elevation: 'number_c=?,
      ~_SlideProps: Js.t({..})=?,
...
module TableBody = {
  ...
  [@bs.obj]
  external makeProps :
    (~className: string=?, ~component: 'union_3=?, unit) => _ =
    "";
  let make =
      (
        ~className: option(string)=?,
...
module TableHead = {
  ...
  [@bs.obj]
  external makeProps :
    (~className: string=?, ~component: 'union_g=?, unit) => _ =
    "";
  let make =
      (
        ~className: option(string)=?,
...
module TablePagination = {
  ...
  external makeProps :
    (
      ...
      ~onChangeRowsPerPage: ReactEventRe.Form.t=?,
      ~page: 'number_0,
      ~rowsPerPage: 'number_m,
      ~rowsPerPageOptions: 'arrayGeneric_u=?,
      ~_SelectProps: Js.t({..})=?,
      ~className: string=?,
      ~numeric: bool=?,
      ~padding: string=?,
  ...
  let make =
      (
        ...
        ~onChangePage: (ReactEventRe.Mouse.t, int) => unit,
        ~onChangeRowsPerPage: option(ReactEventRe.Form.t)=?,
        ~page: [ | `Int(int) | `Float(float)],
        ~rowsPerPage: [ | `Int(int) | `Float(float)],
        ~rowsPerPageOptions: option([ | `ArrayGeneric(array('any_n))])=?,
