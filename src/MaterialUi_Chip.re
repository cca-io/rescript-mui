...
| DeleteIcon(className) => Js.Dict.set(obj, to_string(classType), className)
            ...
            [@bs.obj] external makeProps : (~avatar: ReasonReact.reactElement=?,
~className: string=?,
~clickable: bool=?,
~component: 'union_r43n=?,
...
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/Chip/Chip"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
