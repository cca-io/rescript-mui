...
| Progress(className) => Js.Dict.set(obj, to_string(classType), className)
            ...
            [@bs.obj] external makeProps : (~activeStep: 'number_h=?,
...
~steps: 'number_o,
~variant: string=?,
~component: 'union_rb19=?,
~elevation: 'number_k=?,
~square: bool=?,
~classes: Js.Dict.t(string)=?,~style: ReactDOMRe.Style.t=?, unit) => _ = "";
            [@bs.module "@material-ui/core/MobileStepper/MobileStepper"] external reactClass : ReasonReact.reactClass = "default";
            let make = (
