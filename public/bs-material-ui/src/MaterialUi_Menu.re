...
external makePropsMui:
  (
    ...
    ~anchorOrigin: 'any_ruj7=?,
    ~anchorPosition: 'any_r4k7=?,
    ~anchorReference: string=?,
    ~className: string=?,
    ~container: 'union_r8po=?,
    ~elevation: 'number_c=?,
    ~getContentAnchorEl: 'genericCallback=?,
    ~marginThreshold: 'number_f=?,
    ~transformOrigin: 'any_r64f=?,
    ~_TransitionComponent: 'union_rluw=?,
