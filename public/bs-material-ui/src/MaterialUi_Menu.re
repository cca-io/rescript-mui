...
external makePropsMui:
  (
    ...
    ~anchorOrigin: 'any_rq9w=?,
    ~anchorPosition: 'any_rs0v=?,
    ~anchorReference: string=?,
    ~className: string=?,
    ~container: 'union_r9u7=?,
    ~elevation: 'number_l=?,
    ~getContentAnchorEl: 'genericCallback=?,
    ~marginThreshold: 'number_s=?,
    ~transformOrigin: 'any_rymi=?,
    ~_TransitionComponent: 'union_r8d1=?,
