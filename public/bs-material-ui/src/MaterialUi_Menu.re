...
external makePropsMui:
  (
    ...
    ~transitionDuration: 'union_rcng=?,
    ~variant: string=?,
    ~key: string=?,
    ~ref: ReactDOMRe.domRef=?,
    ~anchorOrigin: 'any_rkc3=?,
    ~anchorPosition: 'any_ryia=?,
    ~anchorReference: string=?,
    ~className: string=?,
    ~container: 'union_rqky=?,
    ~elevation: 'number_v=?,
    ~getContentAnchorEl: 'genericCallback=?,
    ~marginThreshold: 'number_6=?,
    ~transformOrigin: 'any_r1gh=?,
    ~_TransitionComponent: 'union_r6gv=?,
