...
external makePropsMui:
  (
    ...
    ~anchorOrigin: 'any_r4r9=?,
    ~anchorPosition: 'any_rk4d=?,
    ~anchorReference: string=?,
    ~className: string=?,
    ~container: 'union_r08v=?,
    ~elevation: 'number_a=?,
    ~getContentAnchorEl: 'genericCallback=?,
    ~marginThreshold: 'number_g=?,
    ~transformOrigin: 'any_rau6=?,
    ~_TransitionComponent: 'union_rmnn=?,
