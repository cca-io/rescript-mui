...
external makePropsMui:
  (
    ...
    ~id: string=?,
    ~anchorEl: 'union_rcp4=?,
    ~anchorOrigin: 'any_rg9f=?,
    ~anchorPosition: 'any_rs7h=?,
    ~anchorReference: string=?,
    ~children: 'children=?,
    ~className: string=?,
    ~container: 'union_rvp2=?,
    ~elevation: 'number_9=?,
    ...
    ~_open: bool,
    ~_PaperProps: 'any_rsyw=?,
    ~transformOrigin: 'any_rpxr=?,
    ~_TransitionComponent: 'union_rgm8=?,
    ~transitionDuration: 'union_rzhm=?,
