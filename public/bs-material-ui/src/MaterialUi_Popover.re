...
external makePropsMui:
  (
    ...
    ~id: string=?,
    ~anchorEl: 'union_r40k=?,
    ~anchorOrigin: 'any_rwku=?,
    ~anchorPosition: 'any_ry90=?,
    ~anchorReference: string=?,
    ~children: 'children=?,
    ~className: string=?,
    ~container: 'union_r2jf=?,
    ~elevation: 'number_j=?,
    ...
    ~_open: bool,
    ~_PaperProps: 'any_r6ey=?,
    ~transformOrigin: 'any_rk84=?,
    ~_TransitionComponent: 'union_r955=?,
    ~transitionDuration: 'union_rahz=?,
