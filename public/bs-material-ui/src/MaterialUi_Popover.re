...
external makePropsMui:
  (
    ~anchorEl: 'union_rrgg=?,
    ~anchorOrigin: 'any_r48i=?,
    ~anchorPosition: 'any_rgii=?,
    ~anchorReference: string=?,
    ~children: 'children=?,
    ~className: string=?,
    ~container: 'union_r3xv=?,
    ~elevation: 'number_a=?,
    ...
    ~_open: bool,
    ~_PaperProps: 'any_rz3z=?,
    ~transformOrigin: 'any_re59=?,
    ~_TransitionComponent: 'union_rbt2=?,
    ~transitionDuration: 'union_r6zu=?,
    ~_TransitionProps: Js.t({..})=?,
    ~key: string=?,
    ~ref: ReactDOMRe.domRef=?,
    ~_BackdropComponent: 'union_rrlw=?,
    ~_BackdropProps: Js.t({..})=?,
