...
external makePropsMui:
  (
    ...
    ~id: string=?,
    ~anchorEl: 'union_rv2h=?,
    ~anchorOrigin: 'any_rz7i=?,
    ~anchorPosition: 'any_rdnn=?,
    ~anchorReference: string=?,
    ~children: 'children=?,
    ~className: string=?,
    ~container: 'union_rf1d=?,
    ~elevation: 'number_z=?,
    ...
    ~_open: bool,
    ~_PaperProps: 'any_rxh9=?,
    ~transformOrigin: 'any_r4tt=?,
    ~_TransitionComponent: 'union_rmcu=?,
    ~transitionDuration: 'union_r3wv=?,
