...
let shape = (v: TransitionDuration_shape.t) => Any(v);
            ...
            @react.component @bs.module("@material-ui/core") external make : (~\"BackdropComponent": option<BackdropComponent.t>=?,
...
~\"MenuListProps": option<Js.Dict.t<MaterialUi_Types.any>>=?,
...
~\"PopoverClasses": option<Js.Dict.t<MaterialUi_Types.any>>=?,
~transitionDuration: option<TransitionDuration.t>=?,
~variant: option<variant>=?,
~id: option<string>=?,
~style: option<ReactDOMRe.Style.t>=?,
~key: option<string>=?,
~ref: option<ReactDOMRe.domRef>=?,) => React.element = "Menu";
