...
let shape = (v: TransitionDuration_shape.t) => Any(v);
            ...
            @react.component @bs.module("@material-ui/core") external make : (~action: option<React.element>=?,
~anchorOrigin: option<AnchorOrigin.t>=?,
~autoHideDuration: option<MaterialUi_Types.Number.t>=?,
~children: option<'children>=?,
~classes: option<Classes.t>=?,
~className: option<string>=?,
~\"ClickAwayListenerProps": option<Js.Dict.t<MaterialUi_Types.any>>=?,
~\"ContentProps": option<Js.Dict.t<MaterialUi_Types.any>>=?,
...
~ref: option<ReactDOMRe.domRef>=?,) => React.element = "Snackbar";
