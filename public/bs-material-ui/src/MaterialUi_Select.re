...
external makePropsMui:
  (
    ~autoWidth: bool=?,
    ~children: 'children=?,
    ~defaultValue: 'any_rsaz=?,
    ~displayEmpty: bool=?,
    ~_IconComponent: 'union_r2x5=?,
    ~id: string=?,
    ~input: React.element=?,
    ~inputProps: Js.t({..})=?,
    ~label: React.element=?,
...
let makeProps =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_r1w4 => 'any_rtdl)=?,
      ...
      ~inputComponent: option('any_rzey)=?,
