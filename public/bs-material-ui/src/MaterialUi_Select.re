...
let make =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_rzaj => React.element)=?,
      ~_SelectDisplayProps: option(Js.t({..}))=?,
      ~value: option('any_rqd7)=?,
      ~variant: option(variant)=?,
      ~autoComplete: option(string)=?,
      ~autoFocus: option(bool)=?,
      ~className: option(string)=?,
      ~defaultValue: option('any_r1nj)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_r3s9)=?,
      ~inputRef:
         option(
