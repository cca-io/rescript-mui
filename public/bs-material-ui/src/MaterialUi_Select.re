...
external makePropsMui:
  (
    ...
    ~autoWidth: bool=?,
    ~children: 'children=?,
    ~defaultValue: 'any_rba4=?,
    ~displayEmpty: bool=?,
    ~_IconComponent: 'union_rht6=?,
    ~id: string=?,
    ~input: React.element=?,
    ~inputProps: Js.t({..})=?,
    ~label: React.element=?,
...
let makeProps =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_r8bb => 'any_rpex)=?,
