...
let makeProps =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_rjlx => React.element)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_rdy8)=?,
      ~inputRef:
         option(
