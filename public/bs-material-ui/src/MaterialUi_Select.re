...
let makeProps =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_r4xw => React.element)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_r2nh)=?,
      ~inputRef:
         option(
