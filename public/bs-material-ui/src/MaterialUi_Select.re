...
let makeProps =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_r2l0 => React.element)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_rvxq)=?,
      ~inputRef:
         option(
