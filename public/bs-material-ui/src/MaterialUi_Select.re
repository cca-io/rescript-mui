...
let make =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_rltg => React.element)=?,
      ~_SelectDisplayProps: option(Js.t({..}))=?,
      ~value: option('any_rulb)=?,
      ~variant: option(variant)=?,
      ~autoComplete: option(string)=?,
      ~autoFocus: option(bool)=?,
      ~className: option(string)=?,
      ~defaultValue: option('any_rvzt)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_raqe)=?,
      ~inputRef:
         option(
