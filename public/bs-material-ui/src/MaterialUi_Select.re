...
external makePropsMui:
  (
    ...
    ~autoWidth: bool=?,
    ~children: 'children=?,
    ~defaultValue: 'any_r7yr=?,
    ~displayEmpty: bool=?,
    ~_IconComponent: 'union_rwzw=?,
    ~id: string=?,
    ~input: React.element=?,
    ~inputProps: Js.t({..})=?,
    ~label: React.element=?,
...
let makeProps =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_rhms => 'any_r5p2)=?,
