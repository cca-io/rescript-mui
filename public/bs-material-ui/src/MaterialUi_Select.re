...
let makeProps =
    (
      ...
      ~open_: option(bool)=?,
      ~renderValue: option('any_r3ru => React.element)=?,
      ...
      ~id: option(string)=?,
      ~inputComponent: option('any_rqiy)=?,
      ~inputRef:
         option(
