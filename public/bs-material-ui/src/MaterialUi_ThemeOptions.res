...
module MixinsOptions = {
  type t = {"gutters": option<MaterialUi_Types.any>, "toolbar": option<ReactDOM.Style.t>}
  @obj
  external make: (~gutters: MaterialUi_Types.any=?, ~toolbar: ReactDOM.Style.t=?, unit) => t = ""
}
...
module Global = {
  ...
  @obj external make: (~\"@font-face": MaterialUi_Types.any=?, unit) => t = ""
}
