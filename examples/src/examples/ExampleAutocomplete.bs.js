...
function ExampleAutocomplete(props) {
  var match = React.useState(function () {
        return Js_null.fromOption(Belt_Array.get(top100Films, 0));
      });
  ...
  return JsxRuntime.jsxs(JsxRuntime.Fragment, {
              children: [
                ...
                JsxRuntime.jsx(Autocomplete, {
                      ...
                      renderInput: (function (params) {
                          var newrecord = Caml_obj.obj_dup(params);
                          return JsxRuntime.jsx(TextField, (newrecord.variant = "outlined", newrecord.label = "Combo box (controlled)", newrecord));
                        }),
                      getOptionLabel: (function (option) {
                          return option.title;
                        }),
                      id: "combo-box-controlled",
                      inputValue: match$2[0],
                      onInputChange: (function (_event, newInputValue, param) {
                          setInputValue(function (param) {
                                return newInputValue;
                              });
                        }),
                      onChange: (function (_event, newValue, param, param$1) {
                ...
                JsxRuntime.jsx(Autocomplete, {
                      ...
                      defaultValue: [Caml_array.get(top100Films, 13)],
                      multiple: true
                    }),
                JsxRuntime.jsx("br", {}),
                JsxRuntime.jsx(Autocomplete, {
                      ...
                      multiple: true,
                      onChange: (function (_event, newValues, param, param$1) {
